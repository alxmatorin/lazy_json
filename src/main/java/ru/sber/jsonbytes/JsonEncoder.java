...
import ru.sber.jsonbytes.impl.CachingEncoder;
import ru.sber.jsonbytes.impl.JacksonEncoder;

/**
 * Сериализация значения в JSON-байты для {@link JsonBytes#set(String, Object)}.
