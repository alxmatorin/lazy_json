...
public final class PathTrie {
    ...
    public static final class Node {
        ...
        private Node child(JsonPath.Segment segment) {
            return switch (segment) {
                case JsonPath.Key key -> keyChild(key.name()).node;
                case JsonPath.Index index -> indexChild(index.index(), true).node;
                case JsonPath.Wildcard w -> wildcardChild();
            };
        }
    ...
    public static PathTrie of(List<JsonPath> paths) {
    ...
    private void add(JsonPath path, int id) {
    ...
    private static void rejectMixedContainers(Node node, JsonPath.Segment segment) {
        boolean key = segment instanceof JsonPath.Key;
