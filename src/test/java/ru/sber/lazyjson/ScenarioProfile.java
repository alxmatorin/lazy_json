...
import org.example.json.bench.LazyStrategy;
import org.example.json.bench.Op;
import org.example.json.bench.Strategy;

import java.util.List;

/** Warm up first, then attach async-profiler when READY appears. Only the LazyJson strategy runs. */
